		...
		public void onReceive(Context ctxt, Intent intent)
		{
			...
			if (action != null)
			{
				...
				if (action.equals(WifiManager.SUPPLICANT_STATE_CHANGED_ACTION) && net.getWifiInfo())
				{
					...
					{
						info_in_str = getString(R.string.wifi_associating, (net.ssid != null ? net.ssid : (net.bssid != null ? net.bssid : net.macAddress)));
					}
				...
				if (ni.getDetailedState() == NetworkInfo.DetailedState.CONNECTED)
				{
					...
					{ // WIFI
						...
						if (net.ssid != null)
						{
							...
							info_mo_str = getString(R.string.net_mode, getString(R.string.net_mode_wifi, net.speed, WifiInfo.LINK_SPEED_UNITS));
							setButtons(false);
						}
					}
					else if (type == ConnectivityManager.TYPE_MOBILE)
					{ // 3G
						if (prefs.getBoolean(Prefs.KEY_MOBILE, Prefs.DEFAULT_MOBILE) || prefs.getString(Prefs.KEY_INTF, Prefs.DEFAULT_INTF) != null)
						{
							net.getMobileInfo();
							if (net.carrier != null)
							{
								...
								info_mo_str = getString(R.string.net_mode, getString(R.string.net_mode_mobile));
								setButtons(false);
							}
						}
					}
